...
extern void qlog_usbfs_write(int fd, const void *buf, size_t size);

extern unsigned qlog_msecs(void);
#define qlog_raw_log(fmt, arg... ) do { unsigned msec = qlog_msecs(); printf("\r[%03d.%03d] " fmt,  msec/1000, msec%1000, ## arg); } while (0)
